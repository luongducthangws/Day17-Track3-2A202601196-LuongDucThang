...
- Average retrieval latency: **664.5 ms**
- Average token reduction vs full source context: **14.2%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.2 | 133 | 0.0% |  |
| E06 | semantic | PASS | 398.8 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1113.5 | 788 | 0.0% |  |
| E10 | short_term | PASS | 0.3 | 195 | 0.0% |  |
| E02 | long_term | PASS | 1121.4 | 1330 | 0.0% |  |
| E03 | long_term | PASS | 1164.7 | 1354 | 0.0% |  |
| E04 | episodic | PASS | 228.0 | 233 | 0.0% |  |
| E05 | episodic | PASS | 261.7 | 252 | 0.0% |  |
| E07 | mixed | PASS | 1421.0 | 485 | 14.2% |  |
| E11 | semantic | PASS | 209.7 | 146 | 74.2% |  |
| E08 | long_term | PASS | 1390.3 | 1356 | 0.0% |  |
...
`<USER_SUMMARY> The user's personal project is named ORCHID-27, which favors Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used for this project. Python preferences are still valid for personal demos like ORCHID-27.  The user prefers Python over Java and likes short examples when code is explained. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS; Python is not to be used for this project. Python preferences are still valid for personal demos like ORCHID-27.  When explaining async/await, coroutines, and Tasks, use a timeline format. </USER_SUMMARY>  <EPISODES> Episodes are source message or doc`
...
`<LONG_TERM> <USER_SUMMARY> The user's personal project is named ORCHID-27, which favors Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used for this project. Python preferences are still valid for personal demos like ORCHID-27.  The user prefers Python over Java and likes short examples when code is explained. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS; Python is not to be used for this project. Python preferences are still valid for personal demos like ORCHID-27.  When explaining async/await, coroutines, and Tasks, use a timeline format. </USER_SUMMARY>  <EPISODES> Episodes are source me`
